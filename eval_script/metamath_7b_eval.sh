...
#SBATCH --output=metamath_7b_eval_%j.out      # Set this dir where you want slurm outs to go
#SBATCH --output=metamath_7b_eval_%j.out      # Set this dir where you want slurm outs to go
#SBATCH --account=neox
# #SBATCH --exclusive
...
python eval_gsm8k.py --model meta-math/MetaMath-7B-V1.0 --data_file data/test/GSM8K_test.jsonl --tensor_parallel_size 1
