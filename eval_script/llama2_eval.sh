...
python eval_gsm8k.py --model llama2_metainstruct_step250/ --data_file data/test/GSM8K_test.jsonl --tensor_parallel_size 1
python eval_math.py --model llama2_metainstruct_step250/ --data_file data/test/MATH_test.jsonl --tensor_parallel_size 1
