...
#SBATCH --output=install_%j.out      # Set this dir where you want slurm outs to go
#SBATCH --error=install_%j.out      # Set this dir where you want slurm outs to go
#SBATCH --account=neox
# #SBATCH --exclusive
...
pip install vllm==0.1.4 transformers==4.31.0
